...
def B_r_B_t(D_a, l_s, delta_em, theta_p_r, I_s, theta_b_t, theta_b_s, layer_1, layer_2, Y_q, N_c, tau_p):
    ...
    femm.mi_modifycircprop("D+", 1, I_s * np.cos(np.pi / 3))
    femm.mi_modifycircprop("C-", 1, I_s * np.cos(2 * np.pi / 3))
    femm.mi_modifycircprop("F-", 1, I_s * np.cos(np.pi))
    femm.mi_modifycircprop("B+", 1, I_s * np.cos(4 * np.pi / 3))
    femm.mi_modifycircprop("E+", 1, I_s * np.cos(5 * np.pi / 3))
    femm.mi_modifycircprop("A-", 1, -I_s * np.cos(0))
    femm.mi_modifycircprop("D-", 1, -I_s * np.cos(1 * np.pi / 3))
    ...
    femm.mi_modifycircprop("D+", 1, I_s * np.cos(T_elec - np.pi / 3))
    femm.mi_modifycircprop("C-", 1, I_s * np.cos(T_elec  - 2 * np.pi / 3))
    femm.mi_modifycircprop("F-", 1, I_s * np.cos(T_elec  - np.pi))
    femm.mi_modifycircprop("B+", 1, I_s * np.cos(T_elec  - 4 * np.pi / 3))
    femm.mi_modifycircprop("E+", 1,I_s * np.cos(T_elec  - 5 * np.pi / 3))
    femm.mi_modifycircprop("A-", 1, -I_s * np.cos(T_elec))
    femm.mi_modifycircprop("D-", 1, -I_s * np.cos(T_elec - np.pi / 3))
    femm.mi_modifycircprop("C+", 1, -I_s * np.cos(T_elec - 2*np.pi / 3))
    femm.mi_modifycircprop("F+", 1, -I_s * np.cos(T_elec - np.pi / 3))
    femm.mi_modifycircprop("B-", 1,-I_s * np.cos(T_elec  - 4 * np.pi / 3))
    femm.mi_modifycircprop("E-", 1,-I_s * np.cos(T_elec  - 5 * np.pi / 3))
